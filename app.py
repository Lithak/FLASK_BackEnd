...
app.config['MAIL_USERNAME'] = 'lithan71@gmail.com'
app.config['MAIL_PASSWORD'] = 'Litha'
...
def log_table():
    ...
    conn.execute(
        'CREATE TABLE IF NOT EXISTS USERS (id INTEGER PRIMARY KEY AUTOINCREMENT UNIQUE, name TEXT, surname TEXT, email UNIQUE, password NUMERIC)')
